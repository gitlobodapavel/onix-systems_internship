...
SECRET_KEY = 'u(8p(=&(#if#pw2d$mcpb2v@30i(saw)vz*3el-3lpz#lyuz6q'
...
MIDDLEWARE = [
    ...
    'locations.middleware.GetCounrtiesList',
]
...
EMAIL_HOST_USER = 'locationswebapp@gmail.com'
EMAIL_HOST_PASSWORD = 'locationspass123'
EMAIL_PORT = 587
